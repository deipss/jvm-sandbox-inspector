package me.deipss.jvm.sandbox.inspector.debug.consumer.config;
...
@Configuration
@MapperScan(value = "me.deipss.jvm.sandbox.inspector.debug.consumer.dal.classicmodel",
        sqlSessionTemplateRef = "classicmodelSqlSessionTemplate")
