...
public class RocketMqConsumerPlugin extends BasePlugin {
    ...
    public String identify() {
        return Constant.ROCKET_MQ_CONSUMER;
    }
    ...
    public int watch(ModuleEventWatcher watcher, InvocationSendService invocationSendService) {
        new EventWatchBuilder(watcher)
                ...
                .includeSubClasses()
                .onBehavior("consumeMessage")
                .onWatch(new RocketMqConsumerEventListener(entrance(), identify(),invocationSendService), Event.Type.BEFORE, Event.Type.RETURN, Event.Type.THROWS);
